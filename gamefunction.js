/* ╔═══════════════════════════════════════════════════════════════════════════╗
   ...
   /*
    ...
    7. AI 구조물 배치 헬퍼
      ├─ 7-1. 다음 배치 가능한 위치 찾기
      └─ 7-2. 특정 ID 위치에 구조물 배치

    8. 게임 상태 수집 및 출력
      ├─ 8-1. 유닛 생성 기록
      ├─ 8-2. 오래된 유닛 기록 정리
      └─ 8-3. 게임 상태 콘솔 출력 (디버그용)
...
/* ─────────────────────────────────────────────────────────────────────────────
   7-2. 특정 ID 위치에 구조물 배치 (AI 전략 응답용)
   ───────────────────────────────────────────────────────────────────────────── */
...
- 적 포탑 많으면 → 그다음 라운드에 적의 대량 공세를 대비하기 위해 맞으로 포탑 건설, 물량공세 시도시 탱크 유닛우선 배치 필요
- 적 원거리 많으면 → 이동속도가 빠른 근접유닛으로 전력 교환
- 적 근접 많으면 → 탱크+원거리 유닛으로 전력교환
- 적 자원생산소 많으면 → 적의 경제력을 따라가기위해 자원생산소 건설
- 내 기지가 적보다 HP 낮으면 → 포탑을 많이 배치하여 기지 보호
- 유닛별 생산속도가 있으므로 대규모 공세를 하려면 병영이 2개 이상이어야함 그리고 주거지는 비우선순위
